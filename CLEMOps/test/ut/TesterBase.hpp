// ======================================================================
// \title  CLEMOps/test/ut/TesterBase.hpp
// \author Auto-generated
// \brief  hpp file for CLEMOps component test harness base class
//
// \copyright
...
#ifndef CLEMOps_TESTER_BASE_HPP
#define CLEMOps_TESTER_BASE_HPP
...
namespace Ref {
  ...
  //! \class CLEMOpsTesterBase
  //! \brief Auto-generated base class for CLEMOps component test harness
  //!
  class CLEMOpsTesterBase :
    public Fw::PassiveComponentBase
  {
    ...
    public:
      ...
      //! Initialize object CLEMOpsTesterBase
      //!
      virtual void init(
    ...
    public:
      ...
      //! Connect dataResult to to_dataResult[portNum]
      //!
      void connect_to_dataResult(
          const NATIVE_INT_TYPE portNum, /*!< The port number*/
          Ref::InputDataResultPort *const dataResult /*!< The port*/
      );
    ...
    public:
      ...
      //! Get the port that receives input from dataRequest
      //!
      //! \return from_dataRequest[portNum]
      //!
      Ref::InputDataRequestPort* get_from_dataRequest(
          const NATIVE_INT_TYPE portNum /*!< The port number*/
      );
    ...
    protected:
      ...
      //! Construct object CLEMOpsTesterBase
      //!
      CLEMOpsTesterBase(
      ...
      //! Destroy object CLEMOpsTesterBase
      //!
      virtual ~CLEMOpsTesterBase(void);
    ...
    protected:
      ...
      //! Handler prototype for from_dataRequest
      //!
      virtual void from_dataRequest_handler(
          const NATIVE_INT_TYPE portNum, /*!< The port number*/
          DataRequestPortZ data /*!< Possible data types to be requested*/
      ) = 0;

      //! Handler base function for from_dataRequest
      //!
      void from_dataRequest_handlerBase(
          const NATIVE_INT_TYPE portNum, /*!< The port number*/
          DataRequestPortZ data /*!< Possible data types to be requested*/
      );
    ...
    protected:
      ...
      //! Push an entry on the history for from_dataRequest
      void pushFromPortEntry_dataRequest(
          DataRequestPortZ data /*!< Possible data types to be requested*/
      );

      //! A history entry for from_dataRequest
      //!
      typedef struct {
        DataRequestPortZ data;
      } FromPortEntry_dataRequest;

      //! The history for from_dataRequest
      //!
      History<FromPortEntry_dataRequest> 
        *fromPortHistory_dataRequest;
    ...
    protected:
      ...
      //! Invoke the to port connected to dataResult
      //!
      void invoke_to_dataResult(
          const NATIVE_INT_TYPE portNum, /*!< The port number*/
          F32 result 
      );
    ...
    public:
      ...
      //! Get the number of from_dataRequest ports
      //!
      //! \return The number of from_dataRequest ports
      //!
      NATIVE_INT_TYPE getNum_from_dataRequest(void) const;

      //! Get the number of to_dataResult ports
      //!
      //! \return The number of to_dataResult ports
      //!
      NATIVE_INT_TYPE getNum_to_dataResult(void) const;
    ...
    protected:
      ...
      //!
      //! Whether to_dataResult[portNum] is connected
      //!
      bool isConnected_to_dataResult(
          const NATIVE_INT_TYPE portNum /*!< The port number*/
      );
    ...
    protected:
      ...
      //! Send a OPS_Get_Data command
      //!
      void sendCmd_OPS_Get_Data(
    ...
    protected:
      ...
      //! Handle event OPS_CMD_RECV
      //!
      virtual void logIn_ACTIVITY_LO_OPS_CMD_RECV(
          CLEMOpsComponentBase::MathOpEv dataEv 
      );

      //! A history entry for event OPS_CMD_RECV
      //!
      typedef struct {
        CLEMOpsComponentBase::MathOpEv dataEv;
      } EventEntry_OPS_CMD_RECV;

      //! The history of OPS_CMD_RECV events
      //!
      History<EventEntry_OPS_CMD_RECV> 
        *eventHistory_OPS_CMD_RECV;
    ...
    protected:
      ...
      //! Handle event OPS_Result
      //!
      virtual void logIn_ACTIVITY_HI_OPS_Result(
          F32 result 
      );

      //! A history entry for event OPS_Result
      //!
      typedef struct {
        F32 result;
      } EventEntry_OPS_Result;

      //! The history of OPS_Result events
      //!
      History<EventEntry_OPS_Result> 
        *eventHistory_OPS_Result;
    ...
    protected:
      ...
      //! Handle channel OPS_TLM
      //!
      virtual void tlmInput_OPS_TLM(
          const Fw::Time& timeTag, /*!< The time*/
          const CLEMOpsComponentBase::dataTlm& val /*!< The channel value*/
      );

      //! A telemetry entry for channel OPS_TLM
      //!
      typedef struct {
        Fw::Time timeTag;
      ...
      //! The history of OPS_TLM values
      //!
      History<TlmEntry_OPS_TLM> 
        *tlmHistory_OPS_TLM;
    ...
    protected:
      ...
      //! Handle channel OPS_Result
      //!
      virtual void tlmInput_OPS_Result(
          const Fw::Time& timeTag, /*!< The time*/
          const F32& val /*!< The channel value*/
      );

      //! A telemetry entry for channel OPS_Result
      //!
      typedef struct {
        Fw::Time timeTag;
        F32 arg;
      ...
      //! The history of OPS_Result values
      //!
      History<TlmEntry_OPS_Result> 
        *tlmHistory_OPS_Result;
    ...
    private:
      ...
      //! To port connected to dataResult
      //!
      Ref::OutputDataResultPort m_to_dataResult[1];
    ...
    private:
      ...
      //! From port connected to dataRequest
      //!
      Ref::InputDataRequestPort m_from_dataRequest[1];
    ...
    private:
      ...
      //! Static function for port from_dataRequest
      //!
      static void from_dataRequest_static(
