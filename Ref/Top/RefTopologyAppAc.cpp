...
void constructRefArchitecture(void) {  
    ...
    //None
    mathSender.set_CmdReg_OutputPort(0, cmdDisp.get_compCmdReg_InputPort(20));
    //None
    mathSender.set_CmdStatus_OutputPort(0, cmdDisp.get_compCmdStat_InputPort(0));
    //None
    mathSender.set_Log_OutputPort(0, eventLogger.get_LogRecv_InputPort(0));
    //None
    mathSender.set_LogText_OutputPort(0, textLogger.get_TextLogger_InputPort(0));
    //None
    mathSender.set_Tlm_OutputPort(0, chanTlm.get_TlmRecv_InputPort(0));
    //None
    mathSender.set_Time_OutputPort(0, linuxTime.get_timeGetPort_InputPort(0));
    //None
    mathSender.set_mathOut_OutputPort(0, mathReceiver.get_mathIn_InputPort(0));
    //None
    mathReceiver.set_CmdReg_OutputPort(0, cmdDisp.get_compCmdReg_InputPort(21));
    //None
    mathReceiver.set_CmdStatus_OutputPort(0, cmdDisp.get_compCmdStat_InputPort(0));
    //None
    mathReceiver.set_Log_OutputPort(0, eventLogger.get_LogRecv_InputPort(0));
    //None
    mathReceiver.set_LogText_OutputPort(0, textLogger.get_TextLogger_InputPort(0));
    //None
    mathReceiver.set_Tlm_OutputPort(0, chanTlm.get_TlmRecv_InputPort(0));
    //None
    mathReceiver.set_ParamGet_OutputPort(0, prmDb.get_getPrm_InputPort(0));
    //None
    mathReceiver.set_ParamSet_OutputPort(0, prmDb.get_setPrm_InputPort(0));
    //None
